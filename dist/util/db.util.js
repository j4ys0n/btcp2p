...
var nestdb_1 = __importDefault(require("nestdb"));
...
var DbUtil = /** @class */ (function () {
    ...
    DbUtil.prototype.loadCollection = function (filename) {
        var dbPath = path_1.default.join(__dirname, '../../data', (filename + '.db'));
        if (this.dbPath !== undefined) {
            dbPath = path_1.default.join(this.dbPath, (filename + '.db'));
        }
        var ds = new nestdb_1.default({ filename: dbPath });
    ...
    DbUtil.prototype.memoryCollection = function () {
        return Promise.resolve(new nestdb_1.default());
    };
    ...
    DbUtil.prototype.getBlocksForCache = function (name) {
        ...
        return new Promise(function (resolve, reject) {
            blocks.then(function (ds) {
                ds.find({}, { hash: 1, height: 1, prevBlock: 1, nextBlock: 1 }).exec(
                // @ts-ignore
                function (err, blocks) {
                    if (err) {
                        return reject(err);
